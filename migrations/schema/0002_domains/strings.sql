...
--changeset oleh:0002_alpha_string splitStatements:false

CREATE DOMAIN alpha_string AS VARCHAR(128)
...
COMMENT ON DOMAIN alpha_string IS 'not blank VARCHAR(128) alpha string';

--rollback DROP DOMAIN alpha_string;


--changeset oleh:0002_alphanum_string splitStatements:false

CREATE DOMAIN alphanum_string AS VARCHAR(128)
...
COMMENT ON DOMAIN alphanum_string IS 'not blank VARCHAR(128) alphanumeric string';

--rollback DROP DOMAIN alphanum_string;
